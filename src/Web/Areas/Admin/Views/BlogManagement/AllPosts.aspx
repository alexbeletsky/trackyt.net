...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="<%: Url.Content("~/Scripts/Admin/control.editposts.js") + "?ver=104"%>" type="text/javascript"></script>
    <script src="<%: Url.Content("~/Scripts/Admin/controller.editposts.js") + "?ver=104"%>" type="text/javascript"></script>
</asp:Content>
