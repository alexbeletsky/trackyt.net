...
namespace R1UnitTest.HtttpSimulator
{
    [TestFixture]
    public class HttpSimulatorTests
    {
        ...
        //        //ctx.Session["LAGER"] = true;

        //        Economic.Economic econX = new Economic.Economic();

        //        Economic.ASPNetContext aCtx = new ASPNetContext(ctx);
        //        aCtx.appRootPhysPath = @"C:\Sandbox\MarketPackage_14_UnitTest\code\r1";
        //        aCtx.Init();

        //        string fejlBesked = "";
        //        aCtx.Econ.LogInSession(aCtx, 179476, "CES", "c97jxsq8", out fejlBesked);
        //        Assert.AreEqual(null, fejlBesked);

        //        aCtx.SetSessionVar("LAGER", true);
        //        //string connStr = aCtx.GetConnString();
        //        //Assert.AreEqual("xxx", connStr);
        //        int ops = aCtx.GetOpsaetning();
        //        Assert.AreEqual(77843, ops);

        //        decimal res = econX.BeregnDKKBeloeb(aCtx, 310, "EUR", 900);
        //        Assert.AreEqual(2790m, res);

        //        //bool isValid = econX.ValidatePaymentID(aCtx, 1, "xx", ref fejlBesked);
        //        //Assert.AreEqual(isValid, false);
        //        //Assert.AreEqual(fejlBesked, "");                                

        //        aCtx.SetSessionVar("ACCRUALS", true);

        //        bool testX = econX.HarAdgangPeriodisering(aCtx);
        //        Assert.AreEqual(true, testX);

        //        //TODO:
        //        //login så vi har opsætning etc. 
        //        //session skal virke og evt. indlæses de fornødne variable.
        //    }
        //}

        //[Test]
        //public void TestEconomic2()
        //{
        //    using (new HttpSimulator("/", @"c:\inetpub\").SimulateRequest())
        //    {
        //        HttpContext ctx = HttpContext.Current;
        ...
        //        string connString = "server=localhost;database=mp14unittest;uid=economic;pwd=economic;";
        //        Economic.Economic econX = new Economic.Economic();

        //        DbConnection conn = null;
        //        try
        //        {
        //            conn = Economic.DbApp.GetConn(connString, false);

        //            //econX.BeginTrans(conn);

        //            //Sql sql = new Sql();
        //            //sql.Append("INSERT INTO ErrorLog (beskrivelse) VALUES (").AddVal("fra unit test");
        //            //sql.Append(")");
        //            //conn.ExecUpdate(sql.ToString());

        //            //econX.CommitTrans(conn);

        //            var sessionWrapper = new ASPNetSessionWrapper(ctx.Session);

        //            var result = LoginVerification.Login(
        //                  conn, sessionWrapper,
        //                  new LoginInfo(179476, "CES",
        //                        "c97jxsq8",
        //                        LoginInfo.LoginMethod.Api));
        //            //ThrowAnyLoginExceptions(result);

        //            // Login ok
        //            string sessionid = ctx.Session.SessionID;

        //            Economic.ASPNetContext bCtx = new ASPNetContext(ctx);
        //            bCtx.appRootPhysPath = @"C:\Sandbox\MarketPackage_14_UnitTest\code\r1";
        //            bCtx.Init();

        //            bool b = bCtx.Econ.AlphaNumericCoA(bCtx, 90);
        //            b = bCtx.Econ.AlphaNumericCoA(bCtx, 25168);
        //            b = bCtx.Econ.AlphaNumericCoA(bCtx, 3804);

        //            string errmsg = "";
        //            bool isValid = bCtx.Econ.ValidatePaymentID(bCtx, 1, "xx", ref errmsg);
        //            Assert.AreEqual(isValid, false);
        //            Assert.AreEqual(errmsg, "");

        //            Economic.DbApp.CloseConn(conn);
        //        }
        //        catch (Exception e)
        //        {
        //        }
        ...
        //        //Assert.AreEqual("xxx", connStr);
        //        //int ops = aCtx.GetOpsaetning();
        //        //Assert.AreEqual(313, ops);

        //        decimal res = econX.BeregnDKKBeloeb(aCtx, 310, "EUR", 900);
        //        Assert.AreEqual(2790m, res);


        //        //bool bIsValid = econX.ValidatePaymentID(aCtx, 1, "xx", ref fejlBesked);
        //        //Assert.AreEqual(bIsValid, false);
        //        //Assert.AreEqual(fejlBesked, "");
